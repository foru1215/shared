...
export const C1_2023: Question[] = [
  {
    ...
    session: '上期',
    questionNumber: 1,
    questionText: '2023年度 第三種電気主任技術者 (理論) 問1\nこれは過去問題のサンプルテキストです。実際の問題文はここに表示されます。',
    questionImages: [],
    choices: [
      { label: 'イ', text: '50 [A]' },
      { label: 'ロ', text: '75 [A]' },
  ...
  },
  {
    ...
    session: '上期',
    questionNumber: 2,
    questionText: '2023年度 第三種電気主任技術者 問2\n次の記述のうち、正しいものはどれか。',
    questionImages: [],
    choices: [
      { label: 'イ', text: '選択肢1' },
      { label: 'ロ', text: '選択肢2' },
  ...
  },
  {
    ...
    session: '上期',
    questionNumber: 3,
    questionText: '2023年度 第三種電気主任技術者 問3\n計算問題のサンプルです。',
    questionImages: [],
    choices: [
      { label: 'イ', text: '100 [V]' },
      { label: 'ロ', text: '200 [V]' },
  ...
  },
  {
    ...
    session: '上期',
    questionNumber: 4,
    questionText: '2023年度 第三種電気主任技術者 問4\n図記号に関する問題です。',
    questionImages: [],
    choices: [
      { label: 'イ', text: 'コンセント' },
      { label: 'ロ', text: 'スイッチ' },
  ...
  },
  {
    ...
    session: '上期',
    questionNumber: 5,
    questionText: '2023年度 第三種電気主任技術者 問5\n配線設計に関する問題です。',
    questionImages: [],
    choices: [
      { label: 'イ', text: '1.6mm' },
      { label: 'ロ', text: '2.0mm' },
